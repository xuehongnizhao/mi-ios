...
-(void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection{
    ...
    if (metadataObjects.count>0) {
        ...
        [self barcodeScanSucceeded:metadataObject.stringValue format:[self zqFormatStringFrom:metadataObject.type]];
        
    }
}
- (NSString*)zqFormatStringFrom:(NSString *)format {
    if ([format isEqualToString:@"org.iso.QRCode"])      return @"QR_CODE";
    if ([format isEqualToString:@"org.iso.DataMatrix"])      return @"DATA_MATRIX";
    if ([format isEqualToString:@"org.iso.UPC_E"])      return @"UPC_E";
    if ([format isEqualToString:@"org.iso.UPC_A"])      return @"UPC_A";
    if ([format isEqualToString:@"org.iso.EAN_8"])      return @"EAN_8";
    if ([format isEqualToString:@"org.iso.EAN_13"])      return @"EAN_13";
    if ([format isEqualToString:@"org.iso.Code128"])      return @"CODE_128";
    if ([format isEqualToString:@"org.iso.Code39"])      return @"CODE_39";
    if ([format isEqualToString:@"org.iso.ITF"])      return @"ITF";
    return format;
}
//--------------------------------------------------------------------------
